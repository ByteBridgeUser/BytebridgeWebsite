...
export const ProjectSummary = ({
  ...
  const renderDetails2 = visible => (<>
    <div style={{display:"flex"}}>
    {/* <div style={{backgroundColor:"cyan",height:"250px",zIndex:"1000",width:"7px"}}></div> */}
    <div className={styles.details}>
      <div aria-hidden className={styles.index}>
        <div style={{backgroundColor:"cyan",height:"5px",width:"100%"}}>
  ...
  const renderPreview2 = visible => (
    <div className={styles.preview}>
      {model.type === 'laptop' && (
        <>
          {/* {renderKatakana('laptop', visible)} */}
          <div className={styles.model} data-device="laptop" style={{marginRight:"100px"}}>
            <Model
              alt={model.alt}
              cameraPosition={{ x: 0, y: 0, z: 8 }}
              showDelay={700}
        ...
        <Transition in={sectionVisible || focused}>
          {visible => (
            <>
              {alternate && !isMobile && (
                <>
                 {renderPreview2(visible)}
                 
                  {renderDetails2(visible)}
