...
export const Navbar = () => {
  ...
  return (
    <header className={styles.navbar} ref={headerRef}>
      <span  className={styles.logo} style={{position:"absolute",top:"0",left:"0",height:"110px",width:"100%",display:"flex",alignItems:"center",justifyContent:"center",padding:"0px"}}>
        <div>
        ByteBridge
      ...
      <RouterLink
        ...
        aria-label="Byte Bridge, Tech Solutions"
      ...
      {/* {1 && <ThemeToggle data-navbar-item />} */}
    </header>
  );
};
